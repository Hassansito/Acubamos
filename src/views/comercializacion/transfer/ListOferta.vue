<template>
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <div v-else class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" class="btn btn-danger" @click="deleteFewofertas()">
                        Delete Selected
                    </button>
                </div>
            </div>
        ...
        <div class="card-body">
            <KTDatatable :header="tableHeader" :data="ofertas" @on-sort="sort" :checkbox-enabled="true"
                ...
                <template v-slot:actions="{ row: data }">
                    <div>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a @click="deleteOferta(data.id)" class="menu-link px-3">Delete</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                <el-form v-if="isEditable" :model="selectedOferta" ref="formRef">
                                    <!-- Producto -->
                                    ...
                                    <div class="fv-row mb-5">
                                        <el-form-item prop="nombre">
                                            <el-input v-model="selectedOferta.nombre" class="form-control-solid w-250px"
                                    ...
                                    <!-- Descripción -->
                                    <label class="fs-5 fw-semibold form-label mb-5">Descripción:</label>
                                    <div class="fv-row mb-5">
                                        <el-form-item prop="descripcion">
                                            <el-input v-model="selectedOferta.descripcion" type="textarea"
                                                class="form-control-solid w-450px" aria-label="Edit descripcion" />
                                        </el-form-item>
                                    </div>
