    ...
    <div class="container">
        <div id="kt_carousel_3_carousel" class="carousel carousel-custom slide" data-bs-ride="carousel"
            ...
            <div class="carousel-inner pt-8">
                <div v-for="(slide, index) in slides" :key="slide.id" class="carousel-item bg-secondary text-dark"
                    :class="{ active: index === 0 }">
                    <div class="row">
                        <!-- Texto (a la izquierda en pantallas grandes, arriba en pantallas pequeñas) -->
                        <div class="carousel-caption d-block  col-10 col-md-6  d-flex flex-column justify-content-center align-items-start"
                            style="margin-left: -10%; margin-bottom:10%;">
                            <h2 class="text-center">{{ slide.caption }}</h2>
                            <h6 class="text-center">{{ slide.caption2 }}</h6>
                            <h5 class="text-center" style="color: coral;">${{ slide.precio }} CUP</h5>
                            <div>
                            <button class="btn  btn-sm mt-3 mx-2" href="#" style="background-color: coral;">
                                Ver ofertas
                            </button>
                            <button href="#" class="btn btn-icon btn-sm mt-3 btn-secondary" style="border-radius: 50%;">
                                <i class="bi bi-share-fill" style="color: coral;"></i>
                            </button>
                        </div>
                            <button class="btn btn-primary btn-sm mt-3 mx-2" @click="startEditing(slide.id)"
                                >
                                Editar oferta
                            </button>                        
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 d-flex flex-column justify-content-end align-items-end"
                            style="margin-left: 43%;">
                            <img :src="slide.image" class="d-block min-w-50px min-h-50px mw-100 mh-100 mx-auto "
                                alt="Slide image">
                        </div>
                    </div>
                </div>
            ...
            <ol class="p-0 m-0 carousel-indicators carousel-indicators-bullet">
                <li v-for="(slide, index) in slides" :key="slide.id" data-bs-target="#kt_carousel_3_carousel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="saveEdits(editingSlide!)">Save
                            changes</button>
                    </div>
                </div>
            </div>
