            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="mb-4 px-4 py-4 col-11 mx-6">
                        ...
                        <Field name="productName" as="input" type="text" class="form-control"
                    ...
                    <div class="mb-4 px-4 py-4 col-11 mx-6">
                        ...
                        <Field name="firstName" as="input" type="text" class="form-control"
                    ...
                    <div class="mb-4 px-4 py-3 col-11 mx-6">
                        ...
                        <Field name="lastName" as="input" type="text" class="form-control"
                    ...
                    <div class="mb-4 px-4 py-3 col-11 mx-6">
                        ...
                        <Field name="email" as="input" type="email" class="form-control"
                            placeholder="Ponga su correo" />
                        <ErrorMessage name="email" class="text-danger" />
                    </div>
                    <div class="mb-4 px-4 py-3 col-11 mx-6">
                        <label class="required form-label">Telefono</label>
                        <Field name="phone" as="input" type="tel" class="form-control"
